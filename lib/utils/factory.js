 ...
 * @LastEditors: 羊驼
 * @LastEditTime: 2024-05-22 17:16:22
...
export default class TypeFactory {
   ...
   * @return {*}
   */
  rigsterType(typeName, typeValue, color = "rgb(230, 162, 60)", icon = "", btnClass = "") {
  ...
  batchRigster(custom) {
    ...
    for (let { viewComponent, nodeComponent, nodeName = "节点", type, setting, textHandle, saveHandle } of custom) {
      ...
      this.registerComponent(value, node, viewComponent);
    }
  }
}
